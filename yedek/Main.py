...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_image,self.large_test_image,self.image_icon_image,  self.home_image, self.user_list_image, self.add_user_image, self.user_detect_image,self.user_edit_image,self.refresh_image,self.adduser_CANCEL_image,self.info_image=loadimages.loadimages()
        #--------------------------------------------------------------------------------------------------------------------------------------------------------------#
                                        #Load Images#
        ...
        self.info_image=customtkinter.CTkImage(light_image=Image.open(os.path.join(image_path,"info.png")),
        ...
        self.widget.grid(row=3,column=0,padx=10,pady=(250,20))
        ...
        self.fourth_frame.grid_columnconfigure(2, weight=1)
        self.entries=[]
        ...
        for i in range(1,9):
            ...
            self.txtbxframe=customtkinter.CTkFrame(self.fourth_frame,corner_radius=0,fg_color="transparent")
            self.txtbxframe.grid(row=i, column=1,padx=0,pady=10,sticky="s")
            self.entries.append(customtkinter.CTkTextbox(self.txtbxframe,height=0.05, font=customtkinter.CTkFont(size=18)))
            self.navigation_frame_label.grid(row=0, column=0, padx=0, pady=10)  
            self.entries[-1].grid(row=i, column=1, padx=0, pady=10, sticky="s")
        ...
        self.buttonOK.grid(row=9, column=0, padx=10, pady=20)    
        ...
        self.buttonCancel.grid(row=9, column=0, padx=10, pady=20)  
        self.buttonOK.place(relx=0.5,rely=0.2,anchor="center")   
        self.buttonCancel.place(relx=0.7, rely=0.2,anchor="center") 
#--------------------------------------------------------------------------------------------------------------------------------------------------------------#
                                #five Frame#
        # create five frame
        self.five_frame = customtkinter.CTkFrame(self,corner_radius=0, fg_color="transparent")
        self.five_frame.grid_columnconfigure(2, weight=1)
        self.entries1=[]
        self.labelheader1 = customtkinter.CTkLabel(self.five_frame, text="Personel Düzenle",
                                                             font=customtkinter.CTkFont(size=25, weight="bold"))
        self.labelheader1.grid(row=0,column=1,padx=(0,0),pady=0)
        ...
        for i in range(1,9):
            ...
            self.f1.grid(row=i, column=1, padx=0,pady=0)         
            self.navigation_frame_label1 = customtkinter.CTkLabel(self.f1, text=self.labeltext1[i],
                                                             font=customtkinter.CTkFont(size=18, weight="bold"))
            self.txtfrm1=customtkinter.CTkFrame(self.five_frame,corner_radius=0,fg_color="transparent")
            self.txtfrm1.grid(row=i,column=2,padx=0,pady=0,sticky="w")
            self.entries1.append(customtkinter.CTkTextbox(self.txtfrm1,height=0.01, font=customtkinter.CTkFont(size=18)))
            self.navigation_frame_label1.grid(row=0, column=0, padx=5, pady=10)  
            self.entries1[-1].grid(row=i, column=1, padx=0, pady=10, sticky="w")

        self.buttons_frame111=customtkinter.CTkFrame(self.five_frame,corner_radius=0,fg_color="transparent")
        self.buttons_frame111.grid(row=10,column=2, padx=(10,10), pady=0)
        ...
        self.buttonOK=customtkinter.CTkButton(self.buttons_frame111,corner_radius=0,height=40, border_spacing=5, text="Kullanıcı Düzenle",
                                              fg_color="transparent", text_color=("gray10","gray90"),hover_color=("gray70","gray30"),
                                              image=self.add_user_image,anchor="w",font=customtkinter.CTkFont(size=18),command=self.userupdate)
        self.buttonOK.grid(row=9, column=1, padx=10, pady=10,sticky="s")  

        self.buttonCancel1=customtkinter.CTkButton(self.buttons_frame11,corner_radius=0,height=40, border_spacing=5, text="Kullanıcı Sil",
                                              fg_color="transparent", text_color=("gray10","gray90"),hover_color=("gray70","gray30"),
                                              image=self.adduser_CANCEL_image,anchor="w",font=customtkinter.CTkFont(size=18),command=self.userDelete)
        self.buttonCancel1.grid(row=9, column=0, padx=0, pady=10, sticky="s")  
        self.buttonOK.place(relx=0.5,rely=0.25,anchor="center")   
        self.buttonCancel1.place(relx=0.5, rely=0.25,anchor="center") 
        #--------------------------------------------------------------------------------------------------------------------------------------------------------------#
                                #Home Frame#
